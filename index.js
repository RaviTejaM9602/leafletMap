...
const cycle = L.geoJSON(cycles, {
    pointToLayer: function (feature, latlng) {
        return L.marker(latlng, { icon: cycleIcon, keyboard: false, riseOnHover: true });
    },
    onEachFeature: function (feature, layer) {
        if (feature.properties) {
            ...
            <button id="selectPoint">Select Point</button>`;
...
const market = L.geoJSON(markets, {
    pointToLayer: function (feature, latlng) {
        return L.marker(latlng, { icon: marketIcon, keyboard: false, riseOnHover: true});
    },
    onEachFeature: function (feature, layer) {
        if (feature.properties) {
            ...
            <strong>Description:</strong> ${feature?.properties?.Description}<br>
            <button id="selectMarket">Select Point</button>`;
...
L.Control.geocoder({collapsed: false,
    position: 'topleft',
    placeholder: "Search...",
